...
Tu re�ois cet email car tu as �t� choisi pour participer au beta-testing de LaDaube.

Normalement, tu connais d�j� le principe du bouzin, je te refais pas tout le film. Si t'as un doute, tu me demandes (reply � cet email).

L'id�e c'est que tu utilises l'appli afin de donner ton avis, tes recommandations, de traiter... bref, l�che toi !
...
Tu peux lui bourrer le cul : je lui ai coll� un bon gros disque qui devrait encaisser (�vite de d�passer les 50Go quand m�me).
Par contre �a tourne sur mon mac @home, servi par ma livebox, donc ne t'attend pas � des perfs de malades.
Aussi, j'essaie de laisser la machine allum�e le plus possible sans interrompre le service, mais bon, il se peut que ca tombe. Si c'est le cas, retente ta chance un peu plus tard.

Pour l'instant tu peux pas changer ton mot de passe, donc pri�re de ne pas faire n'imp avec les logins des copains !

Voil� je crois que j'ai tout dit. Si tu as des questions, n'h�site pas.
